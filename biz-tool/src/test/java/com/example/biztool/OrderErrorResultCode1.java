 ...
 */
public enum OrderErrorResultCode1 implements ResultCode {
  ...
  OrderErrorResultCode1(String code, String zhMessage, String enMessage) {
    this.code = code;
  ...
  public static void main(String[] args) {
    Class<?> cls = null;
    try {
      cls = Class.forName("com.example.biztool.OrderErrorResultCode1");
